...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      botRegex = /^\/form/; botRegexCalendar = /^\/calendar/; botRegexPickup = /^\/pickup/;
  ...
  else if(request.text && botRegexPickup.test(request.text)) {
    this.res.writeHead(200);
    postMessage("https://goo.gl/forms/NiJlM1Rr5Zvzp1n62");
    this.res.end();
  }
  else {
